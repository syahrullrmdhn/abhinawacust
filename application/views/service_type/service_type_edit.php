<div class="container-fluid">
  <div class="card">
    ...
    <div class="card-body">
      <form action="<?= base_url('index.php/service_type/update/' . $service_type->id); ?>" method="post">
        <div class="mb-3">
        ...
        <div class="d-flex justify-content-end">
          <a href="<?= base_url('index.php/service_type'); ?>" class="btn btn-secondary me-2">Cancel</a>
